		...
		<div class="col-md-12">
			...
			<div class="form-group">
				<div class="col-md-12">
					...
					<button class="btn btn-success btn-sm" id='btn_cat_edit' type="button"><i class="fa fa-pencil font-white"></i> Edit </button>
					<button class="btn btn-success btn-sm" id='btn_cat_delete' type="button"><i class="fa fa-cross font-white"></i> Delete </button>
					</span>
					</div>
				</div>
			...
			<div class="form-group">
				<div class="col-md-12">
					...
					<button class="btn btn-success btn-sm" id='btn_sub_cat_edit' type="button"><i class="fa fa-pencil font-white"></i> Edit </button>
					<button class="btn btn-success btn-sm" id='btn_sub_cat_delete' type="button"><i class="fa fa-cross font-white"></i> Delete </button>
					</span>
					</div>
				</div>
				<div class="col-md-12" style="padding-top: 10px; width: 530px;">
			...
			<div class="form-group">
				<div class="col-md-12">
					...
					<button class="btn btn-success btn-sm" id='btn_sub_sub_cat_edit' type="button"><i class="fa fa-pencil font-white"></i> Edit </button>
					<button class="btn btn-success btn-sm" id='btn_sub_sub_cat_delete' type="button"><i class="fa fa-cross font-white"></i> Delete </button>
					</span>
					</div>
				</div>
				<div class="col-md-12" style="padding-top: 10px; width: 530px;">
	...
	<div class="modal-body">
			<form id="modal-category-form" role="form" class="form-horizontal">
				...
				<div class="form-body">
					...
					<div class="form-group">
						<label class="col-md-3 control-label smaller cl-compact" >Category Name</label>
						<div class="col-md-9">
						<input type="text" class="form-control input-sm" name="cat_name" placeholder="">
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-3 control-label smaller cl-compact" >Description</label>
						<div class="col-md-9">
...
<div id="modal-sub-category" class="modal fade" tabindex="-1" data-width="760" data-backdrop="static" data-keyboard="false">
	...
	<div class="modal-body">
			<form id="modal-sub-category-form" role="form" class="form-horizontal">
				...
				<div class="form-body">
					<div class="form-group">
						<label class="col-md-3 control-label smaller cl-compact" >Category</label>
						<div class="col-md-9">
	...
	<div class="modal-body">
			<form id="modal-sub_sub-category-form" role="form" class="form-horizontal">
				...
				<div class="form-body">
					...
					<div class="form-group">
						<label class="col-md-3 control-label smaller cl-compact" >Sub Category</label>
						<div class="col-md-9">
