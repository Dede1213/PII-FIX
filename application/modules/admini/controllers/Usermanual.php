...
class Usermanual extends APP_Controlleri {
	public function index()
	{
		...
		$data['sidebarMenu'] = $this->getSidebarMenuStructure('admini/usermanual');
		...
		<script src="assets/scripts/admin/manuali.js"></script>
		';
	...
	public function manualInput()
	{
		...
		$data['indonya'] = base_url('index.php/admini/usermanual/manualInput');
		$data['engnya'] = base_url('index.php/admin/usermanual/manualInput');			
		$data['pageLevelStyles'] = '
		<link rel="stylesheet" type="text/css" href="assets/global/plugins/datatables/plugins/bootstrap/dataTables.bootstrap.css"/>
		<link href="assets/global/plugins/bootstrap-modal/css/bootstrap-modal-bs3patch.css" rel="stylesheet" type="text/css"/>
		<link href="assets/global/plugins/bootstrap-modal/css/bootstrap-modal.css" rel="stylesheet" type="text/css"/>
