	...
	<div class="page-content">
		...
		<div class="col-md-12">
			...
			<div class="portlet-body form">
				...
				<?php } ?>
				<form target="_self" action="<?=$site_url?>/admin/news/newsEditData" enctype="multipart/form-data" method="post" id="input-form" role="form" class="form-horizontal">
					...
					<div class="form-body">
						...
						<div class="form-group">
							<label class="col-md-3 control-label">Update Upload Konten Berita</label>
							<div class="col-md-6">
								<input type="file" class="form-control" placeholder="Filename" name="filename" id="news-file">
								<span class="help-block">Jangan Isi Field Ini Bila Tidak Ingin Memperbarui Berita</span>
							</div>
