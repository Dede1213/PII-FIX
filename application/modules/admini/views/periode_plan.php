...
<div class="page-content-wrapper">
	<div class="page-content">
		<!-- BEGIN PAGE HEADER-->
		<h3 class="page-title">
		Regular Periode Untuk Pelaksanaan Action Plan
		</h3>
		<!-- END PAGE HEADER-->
		<div class="row">
		<div class="col-md-12">
		...
		<form class="form-inline" role="form" id="filterForm">
			<div class="form-group">
				...
				<select class="form-control input-medium input-sm" id="filterFormBy">
					...
					<option value="periode_year">Tahun</option>
				</select>
			</div>
			<div class="form-group">
		...
		<div id="form-data" class="modal fade" tabindex="-1" data-width="760" data-keyboard="false">
			...
			<div class="modal-footer">
				<button type="button" data-dismiss="modal" class="btn btn-default">Batalkan </button>
