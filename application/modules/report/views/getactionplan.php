	...
	<div class="page-content">
		...
		<div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li class="bread_tab">
					<a id="bread_tab_title" target="_self" href="javascript:;">Action Plan (Periode)</a>
				</li>
			</ul>
		</div>
		<!-- END PAGE HEADER-->
				...
				<div class="row">
					<div class="col-md-12">			
						<div class="form" id="forexcel">
							<form target="_self" action="<?=$site_url?>/report/risk/apperiode" method="post" id="input-form" role="form" class="form-horizontal">
								<div class="form-body">
									<div class="form-group">
				...
				<div class="row">
					<div class="col-md-12">			
						<div class="form" id="forpdf">
							<form target="_self" action="<?=$site_url?>/report/risk/actionplanpdf" method="post" id="input-form" role="form" class="form-horizontal">
								<div class="form-body">
									<div class="form-group">
										<label class="col-md-3 control-label">Periode</label>
											<div class="col-md-6">
