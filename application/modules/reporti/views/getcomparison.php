	...
	<div class="page-content">
		...
		<div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li class="bread_tab">
					<a id="bread_tab_title" target="_self" href="javascript:;">Comparison Out Of Come</a>
				</li>
			</ul>
		</div>
		<!-- END PAGE HEADER-->
				...
				<div class="row">
					<div class="col-md-12">			
						<div class="form" id="forexcel">
							<form target="_self" action="<?=$site_url?>/report/risk/outofcome" method="post" id="input-form" role="form" class="form-horizontal">
								<div class="form-body">
									<div class="form-group">
										<label class="col-md-3 control-label">Periode 1</label>
											<div class="col-md-6">
												<select class="form-control input-sm" name="periode1">
													<?php 
									...
									<div class="form-group">
										<label class="col-md-3 control-label">Periode 2</label>
											<div class="col-md-6">
												<select class="form-control input-sm" name="periode2">
													<?php 
														foreach ($periode as $key) {
															echo "<option value='".$key->periode_id."'>".$key->periode_name."</option>";
														}
				...
				<div class="row">
					<div class="col-md-12">			
						<div class="form" id="forpdf">
							<form target="_self" action="<?=$site_url?>/report/risk/outcomepdf" method="post" id="input-form" role="form" class="form-horizontal">
								<div class="form-body">
									<div class="form-group">
										<label class="col-md-3 control-label">Periode 1</label>
											<div class="col-md-6">
