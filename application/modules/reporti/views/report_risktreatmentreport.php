	...
	<div class="page-content">
		...
		<div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li class="bread_tab">
					<a id="bread_tab_title" target="_self" href="javascript:;">Risk Treatment Report</a>
				</li>
			</ul>
		</div>
		<!-- END PAGE HEADER-->
				...
				<div class="row">
					<div class="col-md-12">			
						<div class="form" id="forexcel">
							<form   action="<?=$site_url?>/report/risk/risktreatmentreport_excel" method="post" id="input-form" role="form" class="form-horizontal">
								<div class="form-body">
									<div class="form-group">
				...
				<div class="row">
					<div class="col-md-12">			
						<div class="form" id="forpdf">
							<form target="_self" action="<?=$site_url?>/report/risk/risktreatmentreport_pdf" method="post" id="input-form" role="form" class="form-horizontal">
								<div class="form-body">
									<div class="form-group">
										<label class="col-md-3 control-label">Periode</label>
											<div class="col-md-6">
				...
				<div class="row">
					<div class="col-md-12">			
						<div class="form" id="forword">
							<form target="_self" action="<?=$site_url?>/report/risk/risktreatmentreport_word" method="post" id="input-form" role="form" class="form-horizontal">
								<div class="form-body">
									<div class="form-group">
										<label class="col-md-3 control-label">Periode</label>
											<div class="col-md-6">
