...
//ubah under
	...
	*/
	...
	public function updateRiskModify($risk_id, $code, $risk, $impact, $actplan, $control, $objective, $uid, $update_point = 'U') {
		$this->_logHistory($risk_id, $uid, $update_point);
		$par = array();
		$keyupdate = '';
		foreach($risk as $k=>$v) {
