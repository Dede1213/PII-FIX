...
grid.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "ajax": {
            "url": site_url+"/admin/periode/periodeReportGetDataListExclude/"+g_id // ajax source
        },
        "columns": [
	...
	return {
	        ...
	        deleteData: function(data) {
	        	...
	        	mod.find('button.btn-danger').one('click', function(){
	        		...
	        		var url = site_url+'/admin/periode/periodeReportDeleteDataListExclude/'+data.risk_id;
	        		$.post(
	        			url,
	        			{ 'id':  data.DT_RowId},
	        			function( data ) {
