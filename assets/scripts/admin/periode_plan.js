...
grid.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "ajax": {
            "url": site_url+"/admin/periode/periodePlanGetData" // ajax source
        },
        "columns": [
	...
	return {
	        ...
	        init: function() {
	            ...
	            $('#input-form-submit-button').click(function(e) {
	                ...
	                if (me.dataMode == 'add') {
	                	var url = site_url+'/admin/periode/periodePlanInsertData';
	                	var tx = 'Insert';
	                } else {
	                	var url = site_url+'/admin/periode/periodePlanEditData';
	                	var tx = 'Update';
	                }
	                $.post(
	                	url,
	        ...
	        deleteData: function(data) {
	        	...
	        	mod.find('button.btn-danger').one('click', function(){
	        		...
	        		var url = site_url+'/admin/periode/periodePlanDeleteData';
	        		$.post(
	        			url,
	        			{ 'id':  data.DT_RowId},
	        			function( data ) {
