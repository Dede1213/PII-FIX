...
grid.init({
    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "ajax": {
            "url": site_url+"/admin/policy/newsGetData" // ajax source
        },
        "columns": [
           { "data": "GenRowNum" },
           { "data": "title" },
       ...
       "columnDefs": [ {
       	...
       	"render": function ( data, type, full, meta ) {
       		var ret = '<a target="_self" href="'+site_url+'/admin/policy/newsView/'+full.id+'">'+data+'</a>';
       		return ret;
       	}
       } ],
        "order": [
	...
	return {
	        ...
	        init: function() {
	            ...
	            $("#datatable_ajax").on('click', 'button.button-grid-edit', function(e) {
	            	...
	            	location.href=site_url+'/admin/policy/newsEdit/'+data.id;
	            });
	        ...
	        deleteData: function(data) {
	        	...
	        	mod.find('button.btn-danger').one('click', function(){
	        		...
	        		var url = site_url+'/admin/policy/newsDeleteData';
	        		$.post(
	        			url,
	        			{ 'id':  data.DT_RowId},
	        			function( data ) {
