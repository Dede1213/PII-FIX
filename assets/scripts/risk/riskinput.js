	...
	return {
        ...
        controlAddRow: function(nnode) {
        	...
        	$('#control_table > tbody:last-child').append('<tr>'+
        		...
        		'<td>'+
        		'<div class="btn-group">'+
        			'<button type="button" class="btn btn-default btn-xs" onclick="RiskInput.controlTableDelete(this, '+me.dataControlCounter+')"><i class="fa fa-minus-circle font-red"></i></button>'+
        		'</div>'+
        		'</td>'+
        	'</tr>');
        ...
        actionPlanAddRow: function(nnode) {
        	...
        	$('#action_plan_table > tbody:last-child').append('<tr>'+
        		...
        		'<td>'+
        		'<div class="btn-group">'+
        			'<button type="button" class="btn btn-default btn-xs" onclick="RiskInput.actionPlanTableDelete(this, '+me.dataActionPlanCounter+')"><i class="fa fa-minus-circle font-red"></i></button>'+
        		'</div>'+
        		'</td>'+
        	'</tr>');
