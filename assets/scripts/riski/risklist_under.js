    ...
    dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
        ...
        "columnDefs": [ {
        	...
        	"render": function ( data, type, full, meta ) {
        		var cls = 'font-green';
        		if (full.risk_status == '0' || full.risk_status == '1') cls = '';
        		return '<a target="_self" class="'+cls+'" href="'+site_url+'/maini/mainrac/riskRegisterFormunder/'+full.risk_id+'?status=under">'+data+'</a>';
        	}
        }, {
        	"targets": 2,
        	"data": "ap_id",
        	"render": function ( data, type, full, meta ) {
        		var cls = 'font-green';
        		if (full.risk_status == '0' || full.risk_status == '1') cls = '';
        		return '<a target="_self" class="'+cls+'" href="'+site_url+'/riski/RiskRegister/undermaintenance?status=ap&id='+full.risk_id+'">'+data+'</a>';
        	}
        },  {
        	"targets": 6,
        	"data": "risk_status",
...
var RiskList = function() {
	return {
	        ...
	        confirmRisk: function(data) {
	        	var mod = MainApp.viewGlobalModal('confirm', 'Risk Status to <b>Maintenance </b> for risk : <b>'+data.risk_event+'</b> ? ');
	        		...
	        		$.post(
	        			...
	        			function( data ) {
	        				...
	        				if(data.success) {
	        					...
	        					window.location.href = site_url+'/riski/RiskRegister/undermaintenance';
	        ...
	        deleteRisk: function(data) {
	        	var mod = MainApp.viewGlobalModal('warning', 'Are you sure to <b>Stop undermaintenance</b> risk : <b>'+data.risk_event+'</b> ?');
	        		...
	        		$.post(
	        			...
	        			function( data ) {
	        				...
	        				if(data.success) {
	        					...
	        					window.location.href = site_url+'/maini/mainpic#tab_change_request_list';
	        				} else {
	        					MainApp.viewGlobalModal('error', data.msg);
	        				}
