		...
		init: function() {
        	...
        	*/
        	...
        	$('#verify-risk-button-cancel').on('click', function() {
        		...
        		mod.find('button.btn-primary').one('click', function(){
        			location.href=site_url+'/maini/mainrac/riskRegister/'+g_username;
        		});
        	});
        },
            			...
            			if(data.success) {
            				...
            				mod.find('button.btn-ok-success').one('click', function(){
            					...
            					if (submitMode == 'verify' || submitMode == 'verifyPrimary') {
            						location.href=site_url+'/maini/mainrac/riskRegister/'+risk_input_by;
            					} else {
            						location.href=site_url+'/maini/mainrac/riskRegisterForm/'+g_risk_id+'/'+risk_input_by;
            					}
            				});
